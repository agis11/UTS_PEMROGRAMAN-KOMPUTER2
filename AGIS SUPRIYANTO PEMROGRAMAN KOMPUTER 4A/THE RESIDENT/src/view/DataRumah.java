...
public class DataRumah extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelKiri.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 52, -1, 28));
        panelKiri.add(txtNama, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 50, 221, 32));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Alamat");
        panelKiri.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 88, 95, 28));
        panelKiri.add(txtAlamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 88, 221, 32));
        panelKiri.add(txt_no, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 126, 221, 29));
        panelKiri.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 161, 221, 29));
        panelKiri.add(txt_pengembang, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 196, 221, 28));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("No telp.");
        panelKiri.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 126, 95, 29));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Email");
        panelKiri.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 161, 99, 29));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Pengembang");
        panelKiri.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 196, 99, 29));

        cmbTipe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        panelKiri.add(cmbTipe, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 236, 221, 31));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Tipe Perumahan");
        panelKiri.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 236, -1, 30));
        ...
        panelKiri.add(m, new org.netbeans.lib.awtextra.AbsoluteConstraints(363, 278, 30, 30));

        btnSimpan.setBackground(new java.awt.Color(102, 102, 255));
        btnSimpan.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        btnSimpan.setIcon(new javax.swing.ImageIcon("C:\\Users\\AGIS\\Downloads\\icon\\iconcrud\\icons8_Save_as_25px.png")); // NOI18N
        btnSimpan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSimpanActionPerformed(evt);
            }
        });
        panelKiri.add(btnSimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 320, 170, 30));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Brosur");
        panelKiri.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 286, -1, -1));
        panelKiri.add(upload, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 278, 221, 30));
        panelKiri.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -10, 490, 490));
        ...
        btnCari.setIcon(new javax.swing.ImageIcon("C:\\Users\\AGIS\\Downloads\\icon\\iconcrud\\icons8_Search_Property_25px.png")); // NOI18N
        btnCari.setText("Cari");

        btnTambah.setBackground(new java.awt.Color(0, 204, 255));
        btnTambah.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        btnTambah.setIcon(new javax.swing.ImageIcon("C:\\Users\\AGIS\\Downloads\\icon\\iconcrud\\icons8_Plus_25px.png")); // NOI18N
        ...
        btnHapus.setIcon(new javax.swing.ImageIcon("C:\\Users\\AGIS\\Downloads\\icon\\iconcrud\\icons8_Trash_Can_25px.png")); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon("C:\\Users\\AGIS\\Downloads\\icon\\menu1\\icons8_Logout_Rounded_Left_20px.png")); // NOI18N
